...
public final class RecognizeConceptsActivity extends BaseActivity {
  ...
  private void onImagePicked(@NonNull final byte[] imageBytes) {
    ...
    adapter.setData(Collections.<Concept>emptyList(), getApplicationContext());
    ...
    new AsyncTask<Void, Void, ClarifaiResponse<List<ClarifaiOutput<Concept>>>>() {
      ...
      @Override protected void onPostExecute(ClarifaiResponse<List<ClarifaiOutput<Concept>>> response) {
        ...
        adapter.setData(predictions.get(0).data(), getApplicationContext());
        ...
        String toSpeak = "Your observed surroundings "+s;
        if(toSpeak == null)
        {
        ...
        //Toast.makeText(RecognizeConceptsActivity.this , ""+s, Toast.LENGTH_SHORT).show();

        //Toast.makeText(getApplicationContext(), ""+ predictions)
      }
